...
<a href="<?php echo $developer_tools->self_url('do-package').'&name='.$name.'&action=delete-package&package='.$package.'&_wpnonce='.wp_create_nonce('delete-package'); ?>" class = "button-secondary"><?php echo __('Yes, Delete these files', 'framework'); ?></a>

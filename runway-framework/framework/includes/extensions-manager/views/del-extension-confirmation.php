...
<a href="<?php echo admin_url('admin.php?page=extensions&navigation=del-extension&ext='.$_GET['ext'].'&confirm=true&_wpnonce='.wp_create_nonce('del-extension')); ?>" class = "button-secondary"><?php echo __( 'Yes, Delete these files', 'framework' );?></a>

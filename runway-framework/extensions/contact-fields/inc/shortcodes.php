...
add_action("wp_enqueue_scripts", "theme_contact_form_scripts");

function theme_contact_form_scripts() { 
	wp_register_script('theme-contact-form-validate', FRAMEWORK_URL.'extensions/contact-fields/js/jquery.validate.min.js',  array ('jquery'), false, false);   
  wp_register_script('theme-contact-form-ajax', FRAMEWORK_URL.'extensions/contact-fields/js/ajaxForm.js',  array ('jquery'), false, false);
}
...
function theme_contact_form( $atts, $content = null ) {
	...
	wp_enqueue_script('theme-contact-form-validate');
	wp_enqueue_script('theme-contact-form-ajax');

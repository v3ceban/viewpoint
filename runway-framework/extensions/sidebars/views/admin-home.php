					...
					<tr class="active">
						...
						<td class="column-description">
							<p>
								...
								<a style="color: #BC0B0B;" href="<?php echo esc_url( wp_nonce_url( $this->self_url() .'&action=delete-sidebar&alias='. $values['alias'], 'delete-sidebar' ) ); ?>"><?php _e( 'Delete', 'framework' ); ?></a>
							</p>
						</td>
					</tr>
				<?php endforeach; ?>

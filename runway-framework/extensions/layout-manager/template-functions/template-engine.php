...
*		register_context( $news_template, 'News Category', 'news_category' );
*/
if ( ! function_exists( 'register_context' ) ) :
	function register_context( $file_or_function, $name, $context = 'post', $priority = 10, $return_val = 'context' ) {
...
if ( ! function_exists( 'auto_register_wp_category_context' ) ) :
	function auto_register_wp_category_context() {
		...
		foreach ( $category_ids as $cat_id ) {
			...
			register_context( 'verify_wp_category_context', "<strong>".__('Category', 'framework').": </strong>".esc_attr($cat_name), 'category-'.$cat_id );
		}
	}
...
if ( ! function_exists( 'auto_register_custom_post_type_context' ) ) :
	function auto_register_custom_post_type_context() {
		...
		foreach ($post_types as $post_type ) {
			...
			// Register context
			register_context( 'verify_post_type_context', $post_type->labels->name, $post_type->name );
		}
	}
...
if ( ! function_exists( 'auto_register_woocommerce_context' ) ) :
	function auto_register_woocommerce_context() {
		...
		// Default
		register_context( 'verify_woocommerce_context', "<strong>".__('WooCommerce', 'framework').": </strong>".__('Default', 'framework'), 'woocommerce-default' );
		// Home
		register_context( 'verify_woocommerce_context', "<strong>".__('WooCommerce', 'framework').": </strong>".__('Home', 'framework'), 'woocommerce-home' );
		// Product
		register_context( 'verify_woocommerce_context', "<strong>".__('WooCommerce', 'framework').": </strong>".__('Product', 'framework'), 'woocommerce-product' );
		// Category
		register_context( 'verify_woocommerce_context', "<strong>".__('WooCommerce', 'framework').": </strong>".__('Category', 'framework'), 'woocommerce-category' );
		// Tag
		register_context( 'verify_woocommerce_context', "<strong>".__('WooCommerce', 'framework').": </strong>".__('Tag', 'framework'), 'woocommerce-tag' );
		// Cart
		register_context( 'verify_woocommerce_context', "<strong>".__('WooCommerce', 'framework').": </strong>".__('Cart', 'framework'), 'woocommerce-cart' );
		// Checkout
		register_context( 'verify_woocommerce_context', "<strong>".__('WooCommerce', 'framework').": </strong>".__('Checkout', 'framework'), 'woocommerce-checkout' );
		// Account
		register_context( 'verify_woocommerce_context', "<strong>".__('WooCommerce', 'framework').": </strong>".__('Account', 'framework'), 'woocommerce-account' );
